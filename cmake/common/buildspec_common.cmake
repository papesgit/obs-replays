...
function(_check_dependencies)
  ...
  foreach(dependency IN LISTS dependencies_list)
    ...
    string(JSON platform_url ERROR_VARIABLE error GET ${data} baseUrls ${platform})
    if(error)
      set(platform_url ${url})
    endif()
    ...
    if(dependency STREQUAL obs-studio)
      set(url ${platform_url}/${file})
    else()
      set(url ${platform_url}/${version}/${file})
    endif()
